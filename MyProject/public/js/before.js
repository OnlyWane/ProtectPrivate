function getCompany() {
	...
	window.location.href = 'msg_after.html';
}
function getData03() {
	let fileName =  localStorage.getItem('comany_name');
	let page = 1;
	// POST请求
		...
		if (this.status === 200) {
			...
			if (this.response.code === 200) {
                ...
                for (var i = 0; i < data.length; i++) {
                	...
                	var row_ele = document.getElementById('table1');
                ...
                for (var i = 0; i < data.length; i++) {
                	var row = document.createElement('tr');
                	var row_ele = document.getElementById('table2');
                	row_ele.appendChild(row);
                ...
                for (var i = 0; i < data.length; i++) {
                	var row = document.createElement('tr');
                	var row_ele = document.getElementById('table3');
                	row_ele.appendChild(row);
